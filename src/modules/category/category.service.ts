...
import { ConflictMessage, NotFoundtMessage, PublicMessage } from 'src/common/enums/message.enum';
...
export class CategoryService {
  ...
  async findOne(id: number) {
    ...
    if (!category) throw new NotFoundException(NotFoundtMessage.NotFoundCategory)
    return category
  }
